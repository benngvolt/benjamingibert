    ...
    <div>
        ...
        <div className="gemmes_mainDataContainer_descriptionContainer_descriptions">
          ...
          <Reveal>
            <p className="gemmes_mainDataContainer_descriptionContainer_descriptions_3">
              ...
              to celebrate that days grow shorter, light fades, cold settles in,
              with a certain kind of excitement, as the ideal conditions come
              together to prepare a budding. The body enters hibernation, into
              fallow time, in a slowed down rhythm, kept warm, while watching winter
              settle in through a window.
              <br />
              <br />
        ...
        <div className="gemmes_mainDataContainer_descriptionContainer_descriptions">
          ...
          <Reveal>
            <p className="gemmes_mainDataContainer_descriptionContainer_descriptions_2">
              ...
              ont été consacrés à marcher dans la forêt de Fontevraud, à observer
              les feuilles changer de couleur, à écouter les oiseaux, en
              superposant peu à peu les épaisseurs de vêtements.
            </p>
          </Reveal>

          <Reveal>
            <p className="gemmes_mainDataContainer_descriptionContainer_descriptions_3">
              Gemmes est né d&apos;une résidence à l’Abbaye Royale de Fontevraud
              pendant un peu plus d’un mois, dans le prolongement d’une période
              sentimentale et émotionnelle très chaotique. La vie dans l’abbaye et
              le cloître est devenue une seconde peau, protectrice, un espace de
              retrait loin de toute interaction avec l’extérieur.
              <br />
              <br />
              Le mot ‘gemme’ partage sa racine avec ‘bourgeon’, du latin ‘gemmae’.
              <br />
              C’est comme si un élixir avait été préparé pour les hivers à venir.
              Une manière de célébrer le fait que les jours raccourcissent, que la
              lumière s’atténue, que le froid s’installe, avec une certaine forme
              d&apos;excitation, les conditions idéales étant réunies pour préparer
              un bourgeonnement. Le corps entre en hibernation, en jachère, dans un
              temps ralenti, au chaud, en observant l’hiver s’installer à travers
              une fenêtre.
              <br />
              <br />
      ...
      {lang === "jp" && (
        <div className="gemmes_mainDataContainer_descriptionContainer_descriptions">
          ...
          <Reveal>
            <p className="gemmes_mainDataContainer_descriptionContainer_descriptions_3">
              Gemmesは、フォントヴローの王立修道院で一ヶ月余り行われたレジデンスから
              生まれた。それは非常に混沌とした感情や恋愛の時期の延長線上にあった。
              修道院と回廊での生活は、守ってくれる第二の皮膚のようになり、
              外界との関わりから離れた避難所となった。
              <br />
              <br />
              ‘gemme’という語は、ラテン語の‘gemmae’に由来し、
              ‘bourgeon’つまり芽と同じ語根を持つ。
              <br />
              それはまるで、これから来る冬のための霊薬が用意されたかのようだった。
              日が短くなり、光が弱まり、寒さが入り込むことを、
              ある種の高揚感とともに祝うために。
              芽吹きを準備するための理想的な条件が整っていく。
              身体は冬眠へ、休耕の時間へと入り、速度を落とし、暖かさの中で、
              窓越しに冬が定着していくのを見つめる。
              <br />
              <br />
