    ...
    <main className='taihua'>
      ...
      <section className='taihua_mainDataContainer'>
        <div className='taihua_mainDataContainer_firstContainer'>
          ...
          <img className='taihua_mainDataContainer_title' src={taihua_title}/>
          <div className='taihua_mainDataContainer_ecumeContainer'>
            <img className='taihua_mainDataContainer_ecumeContainer_starrysky' src={taihua_ecume}/>
          </div>
          <div className='taihua_mainDataContainer_datas'>
            ...
            <ul>
              ...
              <li>
                05 glassbirds (feat.SVQO)
              </li>
              <li>
                06 low tide cavern II
              </li>
              <li>
                07 shells
              </li>
              <li>
                08 low tide cavern III
              </li>
              <li>
                09 franz josef glacier
              </li>
              <li>
                10 gemme IV + tūīs garden (hurricane version)
              </li>
            </ul>
            <p>
              Tracks 1, 2, 3, 4, 6, 7, 8, 9 composed, played and produced by Benjamin Gibert, recorded in Muriwai (new zealand), 2019. Samples of nature sounds by Benjamin Gibert. <br/><br/>
              Track 9 composed by Benjamin Gibert & SVQO, produced by SVQO, recorded in Lyon (France) and Porto Alegre (Brasil), 2013-2021.<br/>
              Track 10 composed and produced by Benjamin Gibert, recorded in Muriwai (New Zealand) and l'Abbaye Royale de Fontevraud & the forest of Meygal (France), 2021.<br/><br/>
              Artwork by Thomas Vaillant & Benjamin Gibert<br/>
              Recorded, mixed and mastered by Benjamin Gibert at Earthskin Muriwai Residency, New Zealand<br/>
            </p>
            <MusicNetworks/>
          </div>
        </div>
        ...
        <div className='taihua_mainDataContainer_descriptionContainer'>
          <img className='taihua_mainDataContainer_descriptionContainer_objetTypoTitre' src={taihua_objetTypoTitre}/>
          <div className='taihua_mainDataContainer_descriptionContainer_descriptions'>
            ...
            <p className='taihua_mainDataContainer_descriptionContainer_descriptions_3'>
              We strode along many 'taihuas' in new Zealand, searching for sounds and noises, shells, outlooks to native forests or distant islands.<br/><br/>
              We strolled by a mighty and often restless ocean. we surfed on rising tide waves and ran barefoot in the wet ‘taihua’ of the Muriwai beach. We witnessed dusk there, and we photographed pink skies, the surface of the water as a mirror. We captured the echo of caves we could only enter at low-tide. We examined sand covered in shells that chimed like winds, and arranged them by note, depending on their size.<br/><br/>
              Then, we went deeper in the land, along the streams, still barefoot. We threw ourselves into native forests, surrounded by chatty endemic birds.All pieces of ‘taihua’ are about hyper locality. they hold sounds harvested on site, from the crazy melodic phrases of the tui or the piwakawaka, to the upbeat rhythmical patterns of the insects. Humans also have a role in this story, they simply made sure they took off their shoes.
            </p>
          </div>
        </div>
      </section >
      ...
      <div className='taihua_doubleTracksContainer'>
        ...
        <TaihuaTrackBox
          trackNumber={2}
          imgSrc={taihua_lowtidecavernPhoto}
      ...
      <section className='taihua_livePhotosContainer'>
        <div className='taihua_livePhotosContainer_1photo'>
      ...
      <div className='taihua_doubleTracksContainer'>
        <TaihuaTrackBox
          trackNumber={3}
          imgSrc={taihua_nativeforestsPhoto}
      ...
      <section className='taihua_K7Container'>
        <div className='taihua_K7Container_rectoVerso'>
          <img src={taihua_K7recto}/>
          <img src={taihua_K7verso}/>
        </div> 
        <div className='taihua_K7Container_gallery'>
          <img src={taihua_K7_1}/>
          <img src={taihua_K7_2}/>
          <img src={taihua_K7_4}/>
        </div> 
